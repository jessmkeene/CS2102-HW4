 ...
 */
public class LinkedListStrategy implements ParsedDataStrategy{
    /**
     ...
     */
    private LinkedList<Double> newDataIn=new LinkedList<>();
    /**
     * a Linked list of temperature readings
     */
    private LinkedList<Double> allTemps=new LinkedList<>();
    /**
     * a Linked list of humidity readings
     */
    private LinkedList<Double> allHumids=new LinkedList<>();
    /**
     * a Linked list of dates, temperature, and humidity readings
     */
    private LinkedList<Double> DataIn = new LinkedList<>();
    /**
     * a Linked list of Date_Time objects
     */
    private  LinkedList<Date_Time> Data=new LinkedList<>();
    ...
    public void parseData(List<Double> dataIn, Double date_calender) {
        ...
        {}
            ...
            Data.add(new Date_Time(newDataIn.getFirst(), new LinkedList<>(), new LinkedList<>()));
            for (Double d : newDataIn) {
                if (isDateTime(d)) {
                    if (!(sameDate(toDate(d), toDate(Data.getLast().date_time)))) {
                        Data.add(new Date_Time(d, new LinkedList<>(), new LinkedList<>()));
                    }
                } else if (Data.getLast().humidity.isEmpty() && Data.getLast().temp.isEmpty()) {
                    Data.getLast().temp.add(d);
                    allTemps.add(d);
                } else if (Data.getLast().temp.size() > Data.getLast().humidity.size()) {
                    Data.getLast().humidity.add(d);
                    allHumids.add(d);
                } else {
                    Data.getLast().temp.add(d);
                    allTemps.add(d);
